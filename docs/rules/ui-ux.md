...
- Mutable entity tables include select-all, validated bounded bulk actions, by-filter actions, and complete lifecycle controls unless excluded by the domain/audit rules. Dangerous or broad actions require accurate scope/count and explicit confirmation.
