...
- Setiap aksi (link atau button) pada baris data tabel harus diletakkan di **kolom awal tabel** (tepat setelah checkbox). Semua opsi aksi baris ini harus dikelompokkan dalam satu tombol Dropdown berlabel **"Aksi"** (menggunakan format list dropdown menu standard).
