    ...
    <div class="row row-cards">
        ...
        <div class="col-sm-6 col-lg-4">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <span class="avatar bg-info-lt text-info me-3">{{ \Altekno\StarterKit\Support\Starter\StarterNumber::decimal($accessibleAppCount) }}</span>
                        <div>
                            <div class="text-secondary">Akses</div>
                            <div class="h3 mb-0">{{ \Altekno\StarterKit\Support\Starter\StarterNumber::decimal($accessibleAppCount) }} app · {{ \Altekno\StarterKit\Support\Starter\StarterNumber::decimal($sidebarModCount) }} module</div>
                        </div>
                    </div>
                </div>
            </div>
