                        ...
                        <div class="rounded border bg-body-tertiary p-3 mb-4" data-role-form-summary>
                            <div class="d-flex align-items-center gap-3 min-w-0">
                                <span class="avatar {{ $isSuperuserRole ? 'bg-danger-lt text-danger' : 'bg-primary-lt text-primary' }}">
                                    @include('templates.layouts.icon', ['name' => $isSuperuserRole ? 'shield-check' : 'shield-lock', 'class' => 'icon'])
                                </span>
                                <div class="min-w-0">
                        ...
                        <div class="rounded border p-3 mb-4" data-role-system-access>
                            ...
                            <div class="d-flex align-items-start gap-3">
                                <span class="avatar avatar-sm bg-azure-lt text-azure flex-shrink-0">
                                    @include('templates.layouts.icon', ['name' => 'settings', 'class' => 'icon-sm m-0'])
                                </span>
                            ...
                            <div class="d-flex align-items-start gap-3">
                                <span class="avatar avatar-sm bg-purple-lt text-purple flex-shrink-0">
                                    @include('templates.layouts.icon', ['name' => 'history', 'class' => 'icon-sm m-0'])
                                </span>
                                <div class="min-w-0 flex-fill">
                ...
                <div class="card position-xl-sticky" style="top: 1rem;">
                    ...
                    <div class="card-body border-bottom py-3">
                        <div class="d-flex flex-column flex-sm-row align-items-sm-center gap-2">
                            ...
                            <button type="button" class="btn btn-link btn-sm p-0 ms-sm-auto text-decoration-none" wire:click="toggleAllModuleApps">
                                @include('templates.layouts.icon', ['name' => $allModuleAppsExpanded ? 'chevron-up' : 'chevron-down', 'class' => 'icon-sm me-1'])
                                {{ $allModuleAppsExpanded ? 'Tutup semua app' : 'Buka semua app' }}
                            </button>
                        </div>
                    </div>
                        ...
                        @forelse ($modules as $appName => $appModules)
                            ...
                            <div class="accordion-item" wire:key="role-app-modules-{{ $appKey }}">
                                <div class="accordion-header">
                                    <button
                                        class="accordion-button {{ $appExpanded ? '' : 'collapsed' }}"
                                        type="button"
                                        wire:click="toggleModuleApp('{{ $appKey }}')"
                                        aria-expanded="{{ $appExpanded ? 'true' : 'false' }}"
