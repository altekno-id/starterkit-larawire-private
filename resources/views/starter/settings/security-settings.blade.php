            ...
            <div class="border rounded h-100">
                ...
                <div class="p-3">
                    <label class="form-check form-switch mb-4">
                        <input class="form-check-input" type="checkbox" wire:model="securityForm.remember_me_enabled">
                    ...
                    <label class="form-check form-switch mb-4">
                        <input class="form-check-input" type="checkbox" wire:model="securityForm.lock_screen_enabled">
                        <span class="form-check-label">
                    ...
                    <div>
                        ...
                        <div class="input-group">
                            <input
                                ...
                                min="1"
                                max="1440"
                                wire:model="securityForm.lock_screen_timeout_minutes"
            ...
            <div class="border rounded h-100">
                ...
                <div class="p-3">
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control @error('securityForm.login_max_attempts') is-invalid @enderror" id="login-attempts" min="1" max="20" wire:model="securityForm.login_max_attempts">
                    ...
                    <div>
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control @error('securityForm.login_decay_seconds') is-invalid @enderror" id="login-decay" min="30" max="3600" wire:model="securityForm.login_decay_seconds">
                ...
                <div class="p-3">
                    <div class="row">
                        <div class="col-12 col-md-6 col-xl-4">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control @error('securityForm.max_image_size_kb') is-invalid @enderror" id="upload-max-size" min="256" max="10240" step="256" wire:model="securityForm.max_image_size_kb">
