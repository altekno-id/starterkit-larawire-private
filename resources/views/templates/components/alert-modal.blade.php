@php
    ...
    $message = $message ?? ($type === 'danger' ? 'This action cannot be undone.' : 'Your action has been completed successfully.');
    ...
    $passwordPlaceholder = $passwordPlaceholder ?? 'Masukkan password login';
